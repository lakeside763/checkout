import {
  Box, Button, Heading, Text, ModalOverlay,
  ModalContent, ModalHeader, ModalCloseButton, ModalBody, Flex,
    ...
    <Flex>
      ...
      <Box width='calc(100% - 120px)'>
        ...
        <Flex mt='2'>
          ...
          <Text mr='3'>{totalReviews} Review{`${totalReviews > 1 ? 's' : ''}`}</Text>
  ...
  return (
    <Box mt='10' p='2' mb='10' onSubmit={handleSubmit}>
      ...
      <Box as="form" mt='3'>
        ...
        <Button type='submit' mt='5'>Add Review</Button>
      </Box>
    </Box>
  )
}
